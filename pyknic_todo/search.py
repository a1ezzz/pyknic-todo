...
def find_task_or_raise(tasks: list[Task], id_query: str) -> Task:
    # TODO: remove this function!
    idx = find_task_index(tasks, id_query)
    return tasks[idx]


def find_task_index(tasks: list[Task], id_query: str) -> int:
    # TODO: it is better to return tasks instead of indexes!
