...
# from pyknic_todo.models import RecurrenceRule, StateUpdatedEvent, Task, TaskPriority, RecurrenceScheduleType
# from pyknic_todo.models import TaskStatus
...
#         until_date_str = '2026-06-26T06:26:26Z'
...
#         self.assertEqual(rule.until_date, datetime.datetime.fromisoformat(until_date_str))
